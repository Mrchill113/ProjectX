<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ChForm.aspx.cs" Inherits="ProjectX.HTML.ChForm" %>
...
<form method="post" runat="server" onsubmit="return CheckForm();">
    ...
    <table style="width:auto; height: auto;">
        ...
        <tr style="border: 0px solid silver;text-align:center;">
        ...
        <tr style="border: 0px solid silver;">
            <td style="border: 0px solid silver; text-align:center;">
                ...
                &nbsp;
                <input type="checkbox" value="Eating" name="Hobby" /> Eating
            </td>
        </tr>
        <tr style="border: 0px solid silver;">
            <td style="border: 0px solid silver; text-align:center;">
